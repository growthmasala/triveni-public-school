        ...
        <div className="container-main">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              { icon: 'ri-book-open-line', title: 'School Diary System', desc: 'Every student carries a School Diary — a daily, two-way communication channel between teachers and parents, signed by both sides.' },
            ].map((card, i) => (
