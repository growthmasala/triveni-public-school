...
const programs: Programme[] = [
  ...
  },
  {
    ...
    detail: 'Our structured, data-informed remedial programme is designed to identify and address individual learning gaps with precision and care. Through focused support sessions conducted after school hours, students receive personalised attention and targeted guidance to strengthen understanding and build confidence.',
    points: [
      'Identifies individual learning gaps rather than relying on class-wide assumptions',
      'Provides personalised learning pathways tailored to each student',
      'Reinforces key concepts to strengthen understanding',
      'Bridges the gap between classroom instruction and examination readiness',
      'Supports students in achieving their full academic potential',
    ],
  },
  {
    icon: 'ri-scales-line',
    ...
    detail: 'Ethics is not merely displayed on posters but taught as a formal subject within our curriculum. Through dedicated resources and well-structured sessions, we intentionally nurture moral character, integrity and empathy in every student.',
    points: [
      'Supported by dedicated resource materials, ensuring a structured approach',
      'Focuses on continuous moral development rather than one-time interventions',
      'Cultivates empathy, integrity and a strong sense of civic responsibility',
      'Aligned with the school\'s broader character-first philosophy',
    ],
  },
  {
    ...
    detail: 'Through our collaboration with The Times of India and The Hindu, we bring the real world into the classroom. The NIE programme enhances students\' awareness, critical thinking and communication skills through active participation in events such as Play Fest, Fun Fest, seminars, workshops and quiz competitions.',
    points: [
      'Established partnership with the Newspaper in Education (NIE) programme of leading national dailies',
      'Active participation in flagship events such as Play Fest and Fun Fest',
      'Engaging seminars, workshops and sessions that build journalism and communication skills',
      'Regular involvement in quiz competitions and inter-school events, fostering awareness and healthy competition',
    ],
  },
  {
    icon: 'ri-trophy-line',
    ...
    detail: 'Our structured current affairs sessions equip students for national and international competitive examinations. By engaging with real-world developments, students sharpen their analytical thinking, enhance reasoning abilities and develop the agility to respond with clarity and confidence while staying consistently informed about global events.',
    points: [
      'Regular current affairs sessions seamlessly integrated into the academic timetable',
      'Focused preparation for national and international competitive examinations',
      'Strengthens reasoning ability, analytical thinking and awareness of global developments',
      'Special emphasis during the Middle School years to build exam readiness and confidence',
    ],
  },
  {
    ...
    detail: 'Students of our school lead our Waste-Paper Recycling Project — a live sustainability initiative. Through this hands-on effort, they take ownership of a real environmental challenge within the school community, fostering responsibility, collaboration and a deep commitment to sustainable practices.',
    points: [
      'Led by students, fostering ownership and initiative',
      'A live, hands-on project rather than a theoretical exercise',
      'Addresses the real environmental impact of paper waste within the school',
      'Builds leadership, accountability and a strong sense of environmental responsibility',
    ],
  },
]
